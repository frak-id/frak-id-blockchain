...
contract PropertiesSybelTokenTransferable is CryticInterface, SybelToken {
    ...
    function crytic_totalSupply_consistant_ERC20Properties()
        public
        returns (bool)
    {
        return
    ...
    function crytic_revert_transfer_ERC20AlwaysTruePropertiesNotTransferable()
        public
        returns (bool)
    {
    ...
    function crytic_revert_transferFrom_ERC20AlwaysTruePropertiesNotTransferable()
        public
        returns (bool)
    {
