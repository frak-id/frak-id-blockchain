...
manticore contracts/utils/SybelMath.sol --contract=SybelMath --config=tools/manticore/manticore.yaml && 
manticore contracts/utils/SybelRoles.sol --contract=SybelRoles --config=tools/manticore/manticore.yaml'
